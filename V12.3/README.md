...
- [Update to .NET 8](https://github.com/Open-Systems-Pharmacology/PK-Sim/issues/2980)
...
- [Export history to CSV or other text format](https://github.com/Open-Systems-Pharmacology/MoBi/issues/2226)
...
- [Unnecessary starts of PKSim.CLI.exe](https://github.com/Open-Systems-Pharmacology/QualificationRunner/issues/173)
- [Qualification Runner cannot be started from R due to System.IO.FileLoadException](https://github.com/Open-Systems-Pharmacology/QualificationRunner/issues/169)
